...
class QuoteTemplateSeeder extends Seeder
{
    ...
    public function run()
    {
        $template = array(
            ...
            <tbody>
            <tr>
            <td class="td-1"><strong>Quote ID</strong></td>
            <td class="td-2">{quote_id}</td>
            </tr>
            <tr>
            <td class="td-1"><strong>Amount</strong></td>
            <td class="td-2">{quote_amount}</td>
            </tr>
            <tr>
            <td class="td-1"><strong>Due Date</strong></td>
            <td class="td-2">{quote_date_due}</td>
            </tr>
            <tr>
            ...
            <p>You can view your quote and make any payments using the link below.</p>
            <p>Your quote is attached.</p>
            </td>
            </tr>
            <tr>
            ...
            <tbody>
            <tr>
            <td align="center"><a class="button" href="{quote_url}" target="_blank" rel="noopener">View Quote</a></td>
            </tr>
            </tbody>
            </table>
            </td>
            ...
            'emailtemplate_variables' => '{first_name}, {last_name}, {quote_id}, {quote_amount}, {quote_amount_due}, {quote_date_created}, {quote_date_due}, {project_title}, {project_id}, {client_name}, {client_id}, {quote_status}, {quote_url}',
