...
class BolTemplateSeeder extends Seeder
{
    ...
    public function run()
    {
        $template = array(
            ...
            <body
                style="margin: 0;font-family: Verdana, sans-serif;font-size: 1rem;font-weight: 400;line-height: 1.5;color: #212529;text-align: left;background-color: #fff;font-size:10px;">
                ...
                <div>
                    <table style="width: 100%;margin-bottom: 1rem;color: #212529;" class="table table-bordered mb-1">
                        <thead>
                            <tr>
                                <th
                                    style="border: 1px solid #dee2e6;vertical-align: bottom;border-bottom: 2px solid #dee2e6;padding: 0.75rem;vertical-align: top;border-top: 1px solid #dee2e6;text-align:left;border: none !important;font-weight: 800;">
                                ...
                                <th
                                    style="border: 1px solid #dee2e6;vertical-align: bottom;border-bottom: 2px solid #dee2e6;padding: 0.75rem;vertical-align: top;border-top: 1px solid #dee2e6;text-align:right;border: none !important;font-weight: 800;">
                        ...
                        <div class="row mt-4">
                            <div class="col-12 col-lg-12">
                                ...
                                <table style="width: 100%;margin-bottom: 1rem;color: #212529;" class="table table-bordered mb-1">
                                    ...
                                    <thead>
                                        <tr>
                                            <th style="border: 1px solid #dee2e6;vertical-align: bottom;border-bottom: 2px solid #dee2e6;padding: 0.75rem;vertical-align: top;border-top: 1px solid #dee2e6;text-align:left;border: none !important;font-weight: 800;"
                                ...
                                <div class="row mt-3">
                                    <table style="width: 100%;margin-bottom: 1rem;color: #212529;"
                                            ...
                                            <thead>
                                                <tr>
                                                    <td
                                                        style="border: 1px solid #dee2e6;vertical-align: bottom;border-bottom: 2px solid #dee2e6;padding: 0.75rem;vertical-align: top;border-top: 1px solid #dee2e6;text-align:left;border: none !important;">
                                                        Rates that are based on weight or count will be calculated from the quantities loaded.</td>
                                                    <th style="border: 1px solid #dee2e6;vertical-align: bottom;border-bottom: 2px solid #dee2e6;padding: 0.75rem;vertical-align: top;border-top: 1px solid #dee2e6;text-align:right;border: none !important;font-weight: 800;font-size: 15px;color: #f65a6b !important;">
                                    ...
                                    <div class="col-12 col-sm-5 text-grey text-90 order-first order-sm-last">
                                        <table style="width: 100%;margin-bottom: 1rem;color: #212529;"
                                            ...
                                            <tbody >
                                                ...
                                                <tr>
                                                    <td style="border: 1px solid #dee2e6;vertical-align: bottom;border-bottom: 2px solid #dee2e6;padding: 0.75rem;vertical-align: top;border-top: 1px solid #dee2e6;text-align:left;border: none !important;font-weight: 800;"
                                        ...
                                        <div class="row">
                                            <div class="col-4 col-sm-4">
                                                <h3 style="width:25%;text-align:center;padding:8px;color:white;background-color: #f65a6b !important;"
                                                    ...
                                                    FOR</h3>
                                                <table style="width: 100%;margin-bottom: 1rem;color: #212529;border: none !important;">
                                                    <tbody >
                                                        <tr>
                                                            <td
                                                                style="border-bottom-width: 2px;border: 1px solid #dee2e6;padding: 0.75rem;vertical-align: top;border-top: 1px solid #dee2e6;border: none !important;font-weight: 800;">
                                                                Unloading </td>
                                                            <td
                                                                style="border-bottom-width: 2px;border: 1px solid #dee2e6;padding: 0.75rem;vertical-align: top;border-top: 1px solid #dee2e6;">
