...
<form class="form" id="settingsFormGeneral">
    ...
    <div class="form-group row">
        ...
        <!--close modal onbocy click-->
        <div class="form-group row">
            <label for="example-month-input" class="col-12 col-form-label text-left">{{ cleanLang(__('lang.session_timeout_popup')) }}</label>
            <div class="col-12">
                <select class="select2-basic form-control form-control-sm" id="settings_system_session_login_popup"
                    ...
                    <option value="disabled" {{ runtimePreselected('disabled', $settings->settings_system_session_login_popup ?? '') }}>
