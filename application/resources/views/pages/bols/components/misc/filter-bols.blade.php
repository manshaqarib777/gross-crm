<!-- right-sidebar -->
<div class="right-sidebar" id="sidepanel-filter-bols">
    <form>
        <div class="slimscrollright">
            <!--title-->
            <div class="rpanel-title">
                <i class="icon-Filter-2"></i>{{ cleanLang(__('lang.filter_bols')) }}
                <span>
                    <i class="ti-close js-close-side-panels" data-target="sidepanel-filter-bols"></i>
                </span>
            </div>
            <!--title-->
            <!--body-->
            <div class="r-panel-body">
                ...
                <div class="filter-block">
                    ...
                    <div class="fields">
                        <div class="row">
                            <div class="col-md-6 input-group input-group-sm">
                                <span class="input-group-addon">{{ config('system.settings_system_currency_symbol') }}</span>
                                <input type="number" name="filter_bol_payments_min" id="filter_bol_payments_min"
                                    class="form-control form-control-sm" placeholder="min">
                            </div>
                            <div class="col-md-6 input-group input-group-sm">
                                <span class="input-group-addon">{{ config('system.settings_system_currency_symbol') }}</span>
                                <input type="number" name="filter_bol_payments_max" id="filter_bol_payments_max"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <select name="filter_bill_status" id="filter_bill_status"
                                    ...
                                    <option value=""></option>
                                    @foreach(config('settings.bol_statuses') as $key => $value)
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <select name="filter_recurring_option" id="filter_recurring_option"
                                    ...
                                    multiple="multiple" tabindex="-1" aria-hidden="true">
                                    <option value="recurring_bols">{{ cleanLang(__('lang.recurring_bols')) }}</option>
                                    <option value="child_bols">{{ cleanLang(__('lang.recurring_child_bols')) }}</option>
                                </select>
                            </div>
                        </div>
                    </div>
                ...
                <div class="buttons-block">
                    ...
                    <button type="button"
                        ...
                        data-url="{{ urlResource('/bols/search') }}" data-type="form" data-ajax-type="GET">{{ cleanLang(__('lang.apply_filter')) }}</button>
                </div>
            </div>
            <!--body-->
        </div>
