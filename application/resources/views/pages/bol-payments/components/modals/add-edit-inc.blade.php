<div class="row">
    <div class="col-lg-12">
        ...
        <div class="modal-meta-data">
            <small><strong>@lang('lang.balance_due'):</strong> {{ runtimeMoneyFormat($bol->bol_balance) }}</small>
        </div>
        @endif

        <!--bol id-->
        @if(config('settings.visibiliy_payment_modal_bol_field'))
        <div class="form-group row">
            <label class="col-sm-12 col-lg-3 text-left control-label col-form-label required">{{ cleanLang(__('lang.bol_id')) }}*</label>
            <div class="col-sm-12 col-lg-9">
                <div class="input-group input-group-sm">
                    <span class="input-group-addon" id="basic-addon1">{{ config('system.settings_bols_prefix') }}</span>
                    <input type="number" name="payment_bolid" id="bol-payment_bolid"
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-lg-9">
                <div class="input-group input-group-sm">
                    ...
                    <input type="number" name="payment_amount" id="bol-payment_amount" class="form-control form-control-sm"
                        value="{{ $bol->bol_balance ?? '' }}" aria-describedby="basic-addon2">
                </div>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-lg-9">
                ...
                <input class="mysql-date" type="hidden" name="payment_date" id="bol-payment_date"
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-lg-9">
                <select id="bol-payment_gateway" name="payment_gateway" class="select2-basic form-control-sm">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-lg-9">
                <input type="text" name="payment_transaction_id" class="form-control form-control-sm"
                    id="bol-payment_transaction_id" autocomplete="off" placeholder="">
            </div>
        </div>
        ...
        <div id="add_payment_additional_settings" class="hidden">
            <div class="form-group row">
                ...
                <div class="col-sm-12 col-lg-9">
                    <textarea class="form-control" name="payment_notes" id="bol-payment_notes" rows="5"></textarea>
