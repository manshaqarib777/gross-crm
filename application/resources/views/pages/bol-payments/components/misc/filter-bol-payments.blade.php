<!-- right-sidebar -->
<div class="right-sidebar" id="sidepanel-filter-bol-payments">
    <form>
        <div class="slimscrollright">
            ...
            <div class="rpanel-title">
                ...
                <span>
                    <i class="ti-close js-close-side-panels" data-target="sidepanel-filter-bol-payments"></i>
                </span>
            </div>
            <!--title-->
            <!--body-->
            <div class="r-panel-body">
                            ...
                            <div class="col-md-12">
                                <div class="input-group input-group-sm">
                                    <span class="input-group-addon"
                                        id="basic-addon1">{{ config('system.settings_bols_prefix') }}</span>
                                    <input type="text" name="filter_payment_bolid" id="filter_payment_bolid"
                ...
                <div class="filter-block">
                    <div class="title">
                        {{ cleanLang(__('lang.bol-payment_date')) }}
                    </div>
                    <div class="fields">
                        <div class="row">
                            <div class="col-md-6">
                ...
                <div class="filter-block">
                    <div class="title">
                        {{ cleanLang(__('lang.bol-payment_method')) }}
                    </div>
                    <div class="fields">
                        <div class="row">
                            <div class="col-md-12">
                ...
                <div class="buttons-block">
                    ...
                    <button type="button" class="btn btn-rounded-x btn-danger js-ajax-ux-request apply-filter-button"
                        data-url="{{ urlResource('/bol-payments/search') }}" data-type="form"
