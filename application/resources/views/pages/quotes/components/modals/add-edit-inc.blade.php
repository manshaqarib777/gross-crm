                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control  form-control-sm" name="pickup_date" id="pickup_date"
                                    autocomplete="off" value="{{ $quote->pickup_date ?? '' }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control  form-control-sm" name="pickup_time" id="pickup_time"
                                    autocomplete="off" value="{{ $quote->pickup_time ?? '' }}">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control  form-control-sm" name="delivery_date" id="delivery_date"
                                    autocomplete="off" value="{{ $quote->delivery_date ?? '' }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control  form-control-sm" name="delivery_time" id="delivery_time"
                                    autocomplete="off" value="{{ $quote->delivery_time ?? '' }}">
                            </div>
                        </div>
                        <div class="form-group row">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control  form-control-sm" name="contact_mc_dot_number" id="contact_mc_dot_number"  value="{{ $quote->contact_mc_dot_number ?? '' }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control  form-control-sm" name="contact_name" id="contact_name"
                                    autocomplete="off" value="{{ $quote->contact_name ?? '' }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control  form-control-sm" name="contact_phone" id="contact_phone"
                                    autocomplete="off" value="{{ $quote->contact_phone ?? '' }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control  form-control-sm" name="contact_term" id="contact_term"
                                    autocomplete="off" value="{{ $quote->contact_term ?? '' }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control  form-control-sm" name="contact_fax" id="contact_fax"
                                    autocomplete="off" value="{{ $quote->contact_fax ?? '' }}">
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control  form-control-sm" name="contact_address" id="contact_address"
                                    autocomplete="off" value="{{ $quote->contact_address ?? '' }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control  form-control-sm" name="contact_dispatcher" id="contact_dispatcher"
                                    autocomplete="off" value="{{ $quote->contact_dispatcher ?? '' }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control  form-control-sm" name="contact_driver" id="contact_driver"
                                    autocomplete="off" value="{{ $quote->contact_driver ?? '' }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control  form-control-sm" name="contact_truck" id="contact_truck"
                                    autocomplete="off" value="{{ $quote->contact_truck ?? '' }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control  form-control-sm" name="contact_trailer" id="contact_trailer"
                                    autocomplete="off" value="{{ $quote->contact_trailer ?? '' }}">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control  form-control-sm" name="load_mode" id="load_mode"  value="{{ $quote->load_mode ?? '' }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control  form-control-sm" name="load_trailer_type" id="load_trailer_type"
                                    autocomplete="off" value="{{ $quote->load_trailer_type ?? '' }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control  form-control-sm" name="load_trailer_size" id="load_trailer_size"
                                    autocomplete="off" value="{{ $quote->load_trailer_size ?? '' }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control  form-control-sm" name="load_linear_feet" id="load_linear_feet"
                                    autocomplete="off" value="{{ $quote->load_linear_feet ?? '' }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control  form-control-sm" name="load_temperature" id="load_temperature"
                                    autocomplete="off" value="{{ $quote->load_temperature ?? '' }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control  form-control-sm" name="load_length" id="load_length"
                                    autocomplete="off" value="{{ $quote->load_length ?? '' }}">
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control  form-control-sm" name="load_pallet_case_count" id="load_pallet_case_count"
                                    autocomplete="off" value="{{ $quote->load_pallet_case_count ?? '' }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control  form-control-sm" name="load_hazmat" id="load_hazmat"
                                    autocomplete="off" value="{{ $quote->load_hazmat ?? '' }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control  form-control-sm" name="load_requirements" id="load_requirements"
                                    autocomplete="off" value="{{ $quote->load_requirements ?? '' }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control  form-control-sm" name="load_instructions" id="load_instructions"
                                    autocomplete="off" value="{{ $quote->load_instructions ?? '' }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control  form-control-sm" name="load_width" id="load_width"
                                    autocomplete="off" value="{{ $quote->load_width ?? '' }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control  form-control-sm" name="load_height" id="load_height"
                                    autocomplete="off" value="{{ $quote->load_height ?? '' }}">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control  form-control-sm" name="carrier_unloading" id="carrier_unloading"  value="{{ $quote->carrier_unloading ?? '' }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control  form-control-sm" name="carrier_pallet_exchange" id="carrier_pallet_exchange"
                                    autocomplete="off" value="{{ $quote->carrier_pallet_exchange ?? '' }}">
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
