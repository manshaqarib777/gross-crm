<!-- right-sidebar -->
<div class="right-sidebar" id="sidepanel-filter-quote-payments">
    <form>
        <div class="slimscrollright">
            ...
            <div class="rpanel-title">
                ...
                <span>
                    <i class="ti-close js-close-side-panels" data-target="sidepanel-filter-quote-payments"></i>
                </span>
            </div>
            <!--title-->
            <!--body-->
            <div class="r-panel-body">
                            ...
                            <div class="col-md-12">
                                <div class="input-group input-group-sm">
                                    <span class="input-group-addon"
                                        id="basic-addon1">{{ config('system.settings_quotes_prefix') }}</span>
                                    <input type="text" name="filter_payment_quoteid" id="filter_payment_quoteid"
                ...
                <div class="filter-block">
                    <div class="title">
                        {{ cleanLang(__('lang.quote-payment_date')) }}
                    </div>
                    <div class="fields">
                        <div class="row">
                            <div class="col-md-6">
                ...
                <div class="filter-block">
                    <div class="title">
                        {{ cleanLang(__('lang.quote-payment_method')) }}
                    </div>
                    <div class="fields">
                        <div class="row">
                            <div class="col-md-12">
                ...
                <div class="buttons-block">
                    ...
                    <button type="button" class="btn btn-rounded-x btn-danger js-ajax-ux-request apply-filter-button"
                        data-url="{{ urlResource('/quote-payments/search') }}" data-type="form"
