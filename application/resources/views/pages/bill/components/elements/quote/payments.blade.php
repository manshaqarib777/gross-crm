        ...
        <table>
            <tr>
                ...
                <td class="x-payments"> <a href="javascript:void(0)" class="edit-add-modal-button js-ajax-ux-request reset-target-modal-form"
                        ...
                        data-url="{{ urlResource('/payments?action=quote-payments-modal&paymentresource_type=quote&paymentresource_id='.$bill->bill_quoteid) }}"
            ...
            <tr>
                ...
                <td class="x-balance-due"> <span class="x-due-amount-label">
                        @if($bill->quote_balance > 0)
                        <label class="label label-rounded label-danger"
                            id="billing-details-amount-due">{!! runtimeMoneyFormatPDF($bill->quote_balance) !!}</label>
                        @else
                    ...
                    <!--pdf-->
                    <span class="x-due-amount-plain hidden">{!! runtimeMoneyFormatPDF($bill->quote_balance) !!}</span>
                </td>
            </tr>
        </table>
    </div> --}}