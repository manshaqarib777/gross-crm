...
namespace App\Http\Requests\BolPayments;
...
class BolPaymentStoreUpdate extends FormRequest {
    ...
    public function messages() {
        return [
            'payment_bolid.exists' => __('lang.bol_not_found'),
        ];
    }
