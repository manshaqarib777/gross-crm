...
namespace App\Http\Requests\QuotePayments;
...
class QuotePaymentStoreUpdate extends FormRequest {
    ...
    public function messages() {
        return [
            'payment_quoteid.exists' => __('lang.quote_not_found'),
        ];
    }
    ...
    public function rules() {
        ...
        if ($this->getMethod() == 'POST') {
            $rules += [
                'payment_quoteid' => [
                    'required',
                    Rule::exists('quotes', 'bill_quoteid'),
                ],
            ];
        }
