...
/** --------------------------------------------------------------------------------
 * This classes renders the response for the [pdf] process for the quotes
 * controller
 * @package    Grow CRM
 * @author     NextLoop
 *----------------------------------------------------------------------------------*/
...
class PDFResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        //[debugging purposes] view quote in browser (https://domain.com/quote/1/pdf?view=preview)
