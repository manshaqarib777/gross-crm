...
class BolPaymentReceived extends Mailable {
    use Queueable;
    ...
    public function build() {
        ...
        if ($this->user->type == 'team') {
            if (!$template = \App\Models\EmailTemplate::Where('emailtemplate_name', 'New BolPayment')->first()) {
                return false;
            }
        }
        ...
        if ($this->user->type == 'client') {
            if (!$template = \App\Models\EmailTemplate::Where('emailtemplate_name', 'Thank You For BolPayment')->first()) {
                return false;
            }
        }
