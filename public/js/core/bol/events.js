...
$(document).ready(function () {
     ...
     *  [settings][clear cache]
     * -------------------------------------------------------------------------------------------------*/
    $(document).on('click', '.toggle-bol-tax', function (e) {
        NX.toggleBolTaxEditing($(this));
    });
     ...
     * -------------------------------------------------------------------------------------------------*/
    $(document).on('click', '#bol-make-payment-button', function (e) {
        $("#bol-buttons-container").hide();
        $("#bol-pay-container").show();
    });
     ...
     * -------------------------------------------------------------------------------------------------*/
    $(document).on('click', '#bol-cancel-payment-button', function (e) {
        $("#bol-pay-container").hide();
        $(".payment-gateways").hide();
        $("#bol-buttons-container").show();
    });
     ...
     *  [paypal] payment opion selected
     * -------------------------------------------------------------------------------------------------*/
    $(document).on('click', '.bol-pay-gateway-selector', function (e) {
    ...
    $(document).on('click', '#billing-tax-popover-button', function (e) {
        ...
        if ($(this).hasClass('disabled')) {
            ...
            NXBOL.log('[invoicing] initialiseTaxPopover() - tax button is disabled');
        } else {
            NXBOL.toggleTaxDom($("#bill_tax_type").val());
        }
    });
    ...
    $(document).on('click', '#billing-discounts-popover-button', function () {
        ...
        if ($(this).hasClass('disabled')) {
            ...
            NXBOL.toggleDiscountDom($("#bill_discount_type").val());
        }
    });
    ...
    $(document).on('change', '#js-billing-discount-type', function () {
        NXBOL.toggleDiscountDom($(this).val());
    });
    ...
    $(document).on('click', '#itemsModalSelectButton', function (e) {
        NXBOL.DOM.addSelectedProductItems($(this));
    });
    ...
    $(document).on('click', '#expensesModalSelectButton', function (e) {
        NXBOL.DOM.addSelectedExpense($(this));
    });
    ...
    $(document).on('click', '#timebillingModalSelectButton', function (e) {
        NXBOL.DOM.addSelectedTimebilling($(this));
    });
