 ...
 *  [settings][email template selected]
 * -----------------------------------------------------------*/
NX.toggleBolTaxEditing = function ($self) {

    var action = $self.attr('id');

    //clicked on edit button
    if (action == 'bol-tax-edit-button') {
        $("#bol-tax-container").hide();
        $("#bol-edit-tax-container").show();
    }

    //clicked on cancel button
    if (action == 'bol-edit-tax-close-button') {
        $("#bol-edit-tax-container").hide();
        $("#bol-tax-container").show();
    }
}
...
NX.selectPaymentGateway = function ($self) {
    ...
    //hide check list
    $("#bol-pay-options-container").hide();

    //show new title
    $("#bol-pay-title-select-method").hide();
    $("#bol-pay-title-complete-payment").show();
