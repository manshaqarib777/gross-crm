...
$(document).ready(function () {
     ...
     *  [settings][clear cache]
     * -------------------------------------------------------------------------------------------------*/
    $(document).on('click', '.toggle-quote-tax', function (e) {
        NX.toggleQuoteTaxEditing($(this));
    });
     ...
     * -------------------------------------------------------------------------------------------------*/
    $(document).on('click', '#quote-make-payment-button', function (e) {
        $("#quote-buttons-container").hide();
        $("#quote-pay-container").show();
    });
     ...
     * -------------------------------------------------------------------------------------------------*/
    $(document).on('click', '#quote-cancel-payment-button', function (e) {
        $("#quote-pay-container").hide();
        $(".payment-gateways").hide();
        $("#quote-buttons-container").show();
    });
     ...
     *  [paypal] payment opion selected
     * -------------------------------------------------------------------------------------------------*/
    $(document).on('click', '.quote-pay-gateway-selector', function (e) {
    ...
    $(document).on('click', '#billing-tax-popover-button', function (e) {
        ...
        if ($(this).hasClass('disabled')) {
            ...
            NXQUOTE.log('[invoicing] initialiseTaxPopover() - tax button is disabled');
        } else {
            NXQUOTE.toggleTaxDom($("#bill_tax_type").val());
        }
    });
    ...
    $(document).on('click', '#billing-discounts-popover-button', function () {
        ...
        if ($(this).hasClass('disabled')) {
            ...
            NXQUOTE.toggleDiscountDom($("#bill_discount_type").val());
        }
    });
    ...
    $(document).on('change', '#js-billing-discount-type', function () {
        NXQUOTE.toggleDiscountDom($(this).val());
    });
    ...
    $(document).on('click', '#itemsModalSelectButton', function (e) {
        NXQUOTE.DOM.addSelectedProductItems($(this));
    });
    ...
    $(document).on('click', '#expensesModalSelectButton', function (e) {
        NXQUOTE.DOM.addSelectedExpense($(this));
    });
    ...
    $(document).on('click', '#timebillingModalSelectButton', function (e) {
        NXQUOTE.DOM.addSelectedTimebilling($(this));
    });
    ...
    $(document).on('change keyup input paste', '.js_line_validation_item', function () {
        NXQUOTE.DOM.revalidateItem($(this));
    });
