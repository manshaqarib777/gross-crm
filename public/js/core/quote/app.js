...
function NXBootCategories() {
    ...
    //[quote]
    if (page_section == 'quote') {
        if ($("#settings-menu-quotes").attr('aria-expanded') == 'false') {
            $("#settings-menu-quotes").trigger('click');
            $("#settings-menu-categories-quote").addClass('active');
        }
    }
...
/**--------------------------------------------------------------------------------------
 * [QUOTE - CLONE] 
 * @blade : quotes\components\modals\clone.blade.php
 * @description: validation for cloning an quote
 * -------------------------------------------------------------------------------------*/
function NXQuoteClone() {
    //validation
    $("#commonModalForm").validate().destroy();
    $("#commonModalForm").validate({
        rules: {
...
/**--------------------------------------------------------------------------------------
 * [QUOTE - RECURRING] 
 * @blade : quotes\components\modals\recurring-settings.blade.php
 * @description: validation for recurring an quote
 * -------------------------------------------------------------------------------------*/
function NXQuoteRecurring() {
    //validation
    $("#commonModalForm").validate().destroy();
    $("#commonModalForm").validate({
        rules: {
...
/**--------------------------------------------------------------------------------------
 * [QUOTE - ADD] 
 * @blade : quotes\components\modals\add-edit-inc.blade.php
 * @description: validation for creating an quote
 * -------------------------------------------------------------------------------------*/
function NXQuoteCreate() {
    //validation
    $("#commonModalForm").validate().destroy();
    $("#commonModalForm").validate({
        rules: {
...
/**--------------------------------------------------------------------------------------
 * [STRIPE BUTTON] 
 * @description: geneate button shown on quote page
 * -------------------------------------------------------------------------------------*/
function NXStripePaymentButton() {
    ...
    $(document).on('click', '#quote-stripe-payment-button', function () {
...
function NXRazorpayPaymentButton() {
    ...
    $(document).ready(function () {
        $('body').on('click', '#quote-razorpay-payment-button', function (e) {
            //get vars
 ...
 * @description: form validation
 * -------------------------------------------------------------------------------------*/
function NXSettingsQuotes() {
    $("#settingsFormQuotes").validate({
        rules: {
            settings_quotes_recurring_grace_period: "required",
        },
        submitHandler: function (form) {
            nxAjaxUxRequest($("#commonModalSubmitButton"));
        }
...
/**--------------------------------------------------------------------------------------
 * Form validation for converting an estimate to an quote
 * @description: form validation
 * -------------------------------------------------------------------------------------*/
function NXConvertEstimetToQuote() {
    //create status - form validation
    $("#commonModalForm").validate().destroy();
    $("#commonModalForm").validate({
        rules: {
