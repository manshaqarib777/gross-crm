 ...
 *  [settings][email template selected]
 * -----------------------------------------------------------*/
NX.toggleQuoteTaxEditing = function ($self) {

    var action = $self.attr('id');

    //clicked on edit button
    if (action == 'quote-tax-edit-button') {
        $("#quote-tax-container").hide();
        $("#quote-edit-tax-container").show();
    }

    //clicked on cancel button
    if (action == 'quote-edit-tax-close-button') {
        $("#quote-edit-tax-container").hide();
        $("#quote-tax-container").show();
    }
}
...
NX.selectPaymentGateway = function ($self) {
    ...
    //hide check list
    $("#quote-pay-options-container").hide();

    //show new title
    $("#quote-pay-title-select-method").hide();
    $("#quote-pay-title-complete-payment").show();
